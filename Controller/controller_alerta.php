...
class AlertaController extends Alerta
{
  ...
  public function envioTelegram($idalerta,$chatID){
       ...
       window.location= './../View/alertas_detalle.php?idalerta=$idalerta'
       </script>";
...
if (isset($_GET['action']) && $_GET['action']=='atenciont'){
  ...
  if($insntanciacontroller -> atenderAlertaTelegram($_SESSION['idalerta'], $_GET['identidad'], $_SESSION['idpush'])){
    $bandera=true;
  }
