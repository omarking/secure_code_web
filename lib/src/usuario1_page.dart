...
//final response = await http.post("http://locateme.codewaymx.com/alertaMsg.php", body: {
      'alerta': _myState,
    });
...
//final response = await http.post("http://locateme.codewaymx.com/verTokenUs.php", body: {
      'email': '$finalEmail',
    });
    var datauser = json.decode(response.body);
    setState(() {
...
//final response = await http.post("http://locateme.codewaymx.com/verTokenCol.php", body: {
      'email': '$finalEmail',
    });
    var datauser = json.decode(response.body);
    setState(() {
      print('Entra al tokenCol');
      //  tok=datauser;
  ...
  void PushAlert(String token) {
    ...
    http.post('https://fcm.googleapis.com/fcm/send',
        headers: <String, String>{
          ...
          'Authorization':
              //'key=AAAAyDC4rxE:APA91bFSzPSBAiMDt_HBmA7WpRxI_YiRA8pNc0bQbxuqcoYCwMyF6TP2p5d7933DOXh7V-rHO6-hJl9HcGjaCXp0OIlRD_8swRLUEniyLQeT7ne3h1VVs0XtJGq10TA4sHNnIM2FAJct',
  ...
  Future<String> verRoles() async {
    final response = await http
      ...
      //final response = await http.post("http://locateme.codewaymx.com/pantalla.php", body: {
      'email': finalEmail,
    });
    var datauser = json.decode(response.body);
    print(datauser);
...
//http.post("http://locateme.codewaymx.com/emitirAlerta.php", body: {
      'correo': '$finalEmail',
      'alerta': '$_myState',
      'latitud': '$lat',
      'longitud': '$long',
    ...
    print('se envío la alerta');
    verTokenCol();
  }

  Future<String> _getStateList() async {
    final response = await http
        .post("http://192.168.1.71:80/locateme_back/mostrarAlertas.php", body: {
      //final response = await http.post("http://locateme.codewaymx.com/mostrarAlertas.php", body: {
    });
    var datauser = json.decode(response.body);
    setState(() {
      statesList = datauser;
  ...
  Future<dynamic> mostrarAlias() async {
    final response = await http
      ...
      //final response = await http.post("http://locateme.codewaymx.com/mostrarAlias.php", body: {
      "correo": '$finalEmail',
    });
    var datauser = json.decode(response.body);
    alias = datauser[0];
              ...
              child: GoogleMap(
                  ...
                  markers: {
                    Marker(
                      ...
                      icon: icon,
                      infoWindow: InfoWindow(title: "Casa de $alias"),
                    ) // markers: makers,
                  }),
            ),
            Container(
  ...
  Widget _botonEnviarA(BuildContext context) {
    return RaisedButton(
      ...
      // onPressed: (){
      //   Navigator.push(context,MaterialPageRoute(builder: (context) => PruebaMapa()));
      // }
...
//     makers.add(
//       Marker(
//         markerId: MarkerId("MarketCurrent"),
