<?php
include '../assets/resources/fpdff.php';

    
class PDFFINAL extends FPDF
{   
    protected $idalerta;
...
function ChapterBody($fecha,$idalerta,$fechaalert,$idusuario,$usnombre,$descripcion,$latitude,$longitude,$seratencion,$codatencion)
{   session_start();
    ...
    $this->MultiCell(0,5,"Clave de atencion: ".$idalerta);
    $this->MultiCell(0,5,"Clave de alerta: ".$codatencion);
    ...
    $this->MultiCell(0,5,utf8_decode( "Servicio de emergencia: ".$seratencion));
    ...
    $this->Ln(180);
    $this->Image($urlimg,40,110,90,0,'PNG');
    // Salto de línea
...
function PrintChapter($num, $titulo,$fecha,$idalerta,$fechaalert,$idusuario,$usnombre,$descripcion,$latitude,$longitude, $seratencion,$codatencion)
{               
    $this->AddPage();
    $this->ChapterTitle($num,$titulo);
    $this->ChapterBody($fecha,$idalerta,$fechaalert,$idusuario,$usnombre,$descripcion,$latitude,$longitude, $seratencion,$codatencion);
...
function PpintarPDF($num, $titulo,$fecha,$idalerta,$fechaalert,$idusuario,$usnombre,$descripcion,$latitude,$longitude){
    $pdf = new PDF();
    $title = 'Secure Code';
    $pdf->SetTitle($title);
