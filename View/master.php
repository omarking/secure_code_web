    ...
    <ul class="navbar-nav mr-auto" >
      <li class="nav-item active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item glyphicon glyphicon-list-alt" style="font-size:small;" style="color:black;" href="/View/alertas_general.php">NO ATENDIDAS</a>
          <a class="dropdown-item glyphicon glyphicon-hourglass" href="/View/alertas_pendientes.php">PENDIENTES</a>
          <a class="dropdown-item glyphicon glyphicon-ok" href="/View/alertas_aprobadas.php">SOLUCIONADAS</a>
