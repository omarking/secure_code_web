...
class Telegram{
  ...
  if($telegram->enviarTelegramm( $caabecera_message,$uubicacion_calle,$uubicacion_municipio,$udetalle_message,$chatID)){
  ...
  public function enviarTelegramm( $caabecera_message,$uubicacion_calle,$uubicacion_municipio,$udetalle_message,$chatID){
    ...
    $telegramUrl = "https://estadia-1719110304.darkstark96.repl.co/telegram/telegram2.php?message=$cabecera_message&chatid=$chaID";
  $geocodeResponseData = file_get_contents($telegramUrl);
  #$responseData = json_decode($geocodeResponseData, true);

  $telegramUrl = "https://estadia-1719110304.darkstark96.repl.co/telegram/telegram2.php?message=$detalle_message&chatid=$chaID";
  $geocodeResponseData = file_get_contents($telegramUrl);
  #$responseData = json_decode($geocodeResponseData, true);

  $telegramUrl = "https://estadia-1719110304.darkstark96.repl.co/telegram/telegram2.php?message=$ubicacion_calle&chatid=$chaID";
  $geocodeResponseData = file_get_contents($telegramUrl);
  #$responseData = json_decode($geocodeResponseData, true);
  
  $telegramUrl = "https://estadia-1719110304.darkstark96.repl.co/telegram/telegram2.php?message=$ubicacion_municipio&chatid=$chatID";
  $geocodeResponseData = file_get_contents($telegramUrl);
  #$responseData = json_decode($geocodeResponseData, true);
